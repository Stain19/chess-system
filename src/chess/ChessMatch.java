...
public class ChessMatch {
    ...
    private void validateSourcePosition(Position position) {
        ...
        if (!isCurrentPlayerColor(position))
            throw new ChessException("The chosen piece is not yours");
        if (!board.piece(position).isThereAnyPossibleMove())
            throw new ChessException("There is no possible movements for the chosen pieces");
    }
    ...
    private boolean isCurrentPlayerColor(Position position){
        return currentPlayer == ((ChessPiece)board.piece(position)).getColor();
    }
    ...
    private boolean testCheck(Color color){
        ...
        for(Piece p : opponentPieces){
            ...
            if(matrix[kingPosition.getRow()][kingPosition.getColumn()]) return true;
        }
        return false;
    }
